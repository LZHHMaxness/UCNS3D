...
!> This subroutine reads all the data from the grid files
	...
	TYPE(A_NODE_NE),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::inoder
...
Type(A_Wallboundary),Allocatable,Dimension(:):: Wallbnd

Type(A_NodesWall),Allocatable,Dimension(:):: Wallvrt
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
