...
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON6_L
TYPE(A_BOUND_NUMBER),ALLOCATABLE,DIMENSION(:,:),INTENT(INOUT)::IBOUND_L
TYPE(A_U_CENTRE),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::U_C_L, U_Ct_L
TYPE(A_INTEGRALBASIS),ALLOCATABLE,DIMENSION(:)::INTEG_BASIS_L,integ_basis_dg_L
TYPE(A_NODE_NE),ALLOCATABLE,DIMENSION(:)::INODER4_L
TYPE(A_EXCHANGE_SOLHI),ALLOCATABLE,DIMENSION(:)::IEXSOLHIR_L
...
TYPE(A_ELEMENT_NUMBER),ALLOCATABLE,DIMENSION(:,:),INTENT(INOUT)::IELEM_L
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON3_L, ILOCAL_RECON5_L
TYPE(A_BOUND_NUMBER),ALLOCATABLE,DIMENSION(:,:),INTENT(INOUT)::IBOUND_L
...
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON3_L
TYPE(A_BOUND_NUMBER),ALLOCATABLE,DIMENSION(:,:),INTENT(INOUT)::IBOUND_L
TYPE(A_U_CENTRE),ALLOCATABLE,DIMENSION(:)::U_C_L
TYPE(A_NODE_NE),ALLOCATABLE,DIMENSION(:)::INODER4_L
TYPE(A_EXCHANGE_SOLHI),ALLOCATABLE,DIMENSION(:)::IEXSOLHIR_L
...
TYPE(A_ELEMENT_NUMBER),ALLOCATABLE,DIMENSION(:,:),INTENT(INOUT)::IELEM_L
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON3_L
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON5_L,ILOCAL_RECON6_L
TYPE(A_INTEGRALBASIS),ALLOCATABLE,DIMENSION(:)::INTEG_BASIS_L,integ_basis_dg_L
TYPE(A_U_CENTRE),ALLOCATABLE,DIMENSION(:)::U_C_L
...
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON3_L
TYPE(A_LOCAL_RECON3),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ILOCAL_RECON5_L,ILOCAL_RECON6_L
TYPE(A_U_CENTRE),ALLOCATABLE,DIMENSION(:)::U_Ct_L
TYPE(A_INTEGRALBASIS),ALLOCATABLE,DIMENSION(:)::INTEG_BASIS_L,integ_basis_dg_L
